...
# @time: 3/14/2023 3:02 PM

import re
from typing import Any


def command_to_dict(s0, arg_names=None, defaults=None):
    """
    kw参数第一个字符不能为数字, 复杂的东西用字符串括起来
    没有详细的报错信息
...
if __name__ == '__main__':
    print(command_to_dict(r'print -f loc -90 -g 89 89 "fff"', ['f', 'g']))
